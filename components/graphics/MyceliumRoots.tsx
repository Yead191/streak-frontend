...
const ROOTS: { d: string; color: "green" | "orange"; w: number }[] = [
  {
    d: "M600 0 C 560 200 520 200 540 320 C 555 420 500 520 520 640 C 535 740 590 820 560 840",
    color: "green",
    w: 3.5,
  },
  {
    d: "M600 0 C 640 120 690 220 660 340 C 635 450 700 540 680 660 C 665 770 620 860 670 840",
    color: "orange",
    w: 3,
  },
  {
  ...
  { d: "M520 640 C 440 700 380 760 380 840", color: "green", w: 2 },
  { d: "M680 660 C 780 720 840 780 820 840", color: "orange", w: 2 },
  // { d: "M600 0 C 600 240 600 520 600 850", color: "green", w: 1.6 },
