    ...
    >
      <div className="pl-content relative flex flex-col items-center">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(125,255,87,0.45) 0%, rgba(255,122,24,0.14) 42%, rgba(255,122,24,0) 70%)",
            opacity: 0.35,
            willChange: "transform, opacity",
          }}
        />

        {/* the Streak mark wrapper to prevent Safari drop-shadow clipping/breakout bugs */}
        <div
        ...
        <span
          ...
          style={{
            opacity: 0,
            background:
              "linear-gradient(90deg, rgba(125, 255, 87, 0), var(--green), rgba(125, 255, 87, 0))",
